...
public class StarDrawer extends Drawer {
    ...
    public StarDrawer(Canvas c, Labeled ilabel) {
        super(c, ilabel);
    ...
    public StarDrawer(Canvas c, Labeled ilabel, int nsides) {
        super(c, ilabel);
    ...
    public void draw() {
        ...
        for(int i = 0; i < numSides; i++) {
            ...
            // x coord
            theCorners[0][i] = effectiveRadius * Math.cos(theta) + center[0];

            // y coord
            theCorners[1][i] = effectiveRadius * Math.sin(theta) + center[1];
        }
